    ...
    <>
      {showInfluencerProfile ? (
        ...
        <>
          ...
          <form onSubmit={handleSubmit} className="w-full rounded-lg px-8 pt-6 pb-8 mb-4  ">
            <div className="mb-4">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                onChange={handleChange}
                className="shadow-md appearance-none border border-gray-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring focus:ring-orange-300"
            ...
            <div className="flex justify-between"><button className="OrangeButtonWithText-v4 justify-center flex text-center py-2 cursor-pointer w-[150px]">Predict</button></div>
