...
const BlogPost = ({ Title, Body, Time, Image, blogID }) => {
  ...
  const handleEdit = () => {
    navigate(`/Blog/EditBlog/${blogID}`, {
      state: { title: Title, body: Body, image: Image, blogID },
    });
  };
          ...
          <div className="flex justify-between mt-2">
            ...
            <div className="relative">
              ...
              {showMenu && (
                <div
                  ref={menuRef}
                  className="absolute right-0 mt-2 w-28 bg-white border border-gray-200 rounded-md shadow-lg z-50"
                >
                  <ul>
                    <li
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
          <div className="bg-white p-5 rounded-lg shadow-lg">
            ...
            <div className="flex justify-end mt-3">
              <div
                className="w-full bg-orange-500 text-white py-2 px-4 rounded-lg flex justify-center mx-3 cursor-pointer"
                onClick={handleDelete}
              >
                Yes
              </div>
              <div
                className="w-full text-primary border-primary border-2 flex justify-center items-center px-4 rounded-lg outline-2 mx-3 cursor-pointer"
