...
import TinyAreaChartCustomer from '../Charts/TinyAreaChartCustomer';

const CardCustomer = ({ Heading, totalNumbers, Status, Percentage, time,data2 }) => {
